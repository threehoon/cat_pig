...
#
# Grok 直接读 .grok/skills/，Codex 通过 .agents/skills 软链接读同一份。Claude Code
# 不能这么接：软链接的 skill 目录会导致 /app-pet 报 Unknown skill，所以这里同步出
# 一个真实目录。.claude/skills/ 是生成产物，已 gitignore，改动请改 .grok/skills/。
#
